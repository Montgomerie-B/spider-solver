...
Write-Host "4. CONTROL_187 scientific calibration"
python -m pytest -q tests/test_scientific_campaign_portability_v0_99.py::test_worker_is_lean_and_equivalent tests/test_scientific_campaign_portability_v0_99.py::test_control_187_campaign_solves --tb=short
