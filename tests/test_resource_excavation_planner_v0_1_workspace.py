"""v0.1 standalone workspace-investment gate.

INVEST_WORKSPACE / RECOVER_WORKSPACE must be necessary on their own.
PREPAY and TEMPORARY_REWORK must not be able to substitute.
"""
