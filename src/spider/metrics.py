...
# Historical v0.74 autonomous parent (solutions/4925153_autonomous_v0_74.moves).
# Frozen experiments that intentionally require that parent must use this name.
V074_AUTONOMOUS_INCUMBENT_MW = 187
# Back-compat alias for frozen v0.68-v0.99 modules/tests. NOT the current incumbent.
# Current autonomous incumbent is spider.incumbent.current_incumbent_g() (186 as of v0.100).
AUTONOMOUS_INCUMBENT_MW = V074_AUTONOMOUS_INCUMBENT_MW
